// 1. Pegar o elemento de  **botão** para ser adicionado o **evento de clique** nele.  -feito
// 2. Pegar o elemento de **id do conselho** -feito
...
document.getElementById("cubo").addEventListener('click', async function (event) {
    const descConselho = document.getElementById('descConselho');

    const dados = await conselhoAleatorio();

    descConselho.innerText = `${dados.slip.advice}`;
